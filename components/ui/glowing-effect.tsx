      ...
      <div
        ...
        style={{
          ...
          "--gradient": variant === "white"
            ...
            : `radial-gradient(circle, #e8ff5a 10%, #e8ff5a00 20%),
               radial-gradient(circle at 40% 40%, #5affea 5%, #5affea00 15%),
               radial-gradient(circle at 60% 60%, #a78bfa 10%, #a78bfa00 20%), 
               radial-gradient(circle at 40% 60%, #5affea 10%, #5affea00 20%),
               repeating-conic-gradient(
                 from 236.84deg at 50% 50%,
                 #e8ff5a 0%,
                 #5affea calc(25% / var(--repeating-conic-gradient-times)),
                 #a78bfa calc(50% / var(--repeating-conic-gradient-times)), 
                 #5affea calc(75% / var(--repeating-conic-gradient-times)),
                 #e8ff5a calc(100% / var(--repeating-conic-gradient-times))
               )`,
